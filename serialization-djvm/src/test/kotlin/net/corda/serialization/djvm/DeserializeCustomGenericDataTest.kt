...
class DeserializeCustomGenericDataTest: TestBase(KOTLIN) {
    companion object {
        ...
        @JvmStatic
        fun checkData() {
            assertNull(GenericData::class.java.getAnnotation(CordaSerializable::class.java),
                "This class must NOT be annotated as @CordaSerializable!")
            assertNull(ComplexGenericData::class.java.getAnnotation(CordaSerializable::class.java),
                "This class must NOT be annotated as @CordaSerializable!")
        }
    }
